...
/**
 * {@link TransactionRepository} tests
 * 
...
public class TransactionRepositoryTest {
        ...
        public void testEmptyDB() {
                ...
                Assertions.assertEquals(0,
                                transactionRepository
                                                .getTransactionsByTokenSymbolAndFromAccountAndToAccountBetweenTimeStamps(
                                                                "ABC", "from", "to", now.minusHours(1), now)
                                                .size());
                Assertions.assertEquals(0,
                                transactionRepository.getTransactionsByTokenSymbolAndAccount("ABC", "from").size());
        ...
        public void testNonEmptyDB() {
                ...
                Assertions.assertEquals(2,
                                transactionRepository.getTransactionsByTokenSymbolAndAccount("ABC", "from").size());
                Assertions.assertEquals(2,
                                transactionRepository.getTransactionsByTokenSymbolAndAccount("ABC", "to").size());
        ...
        public void testCleanDB() {
                ...
                Assertions.assertEquals(0, transactionRepository.getAllTransactions("ABC").size());
                // Assertions.assertEquals(0,
                // transactionRepository.getAllTransactionsByTokenSymbolFromDateToDate("ABC",
